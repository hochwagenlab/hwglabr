#' Read gff file
#'
#' This function allows you to read a gff file. It uses 'read.table()' to load the
...
#' @param nrows Optional maximum number of rows to read (the exact argument to 'nrows'
#' of 'read.table()'). Defaults to all rows.
